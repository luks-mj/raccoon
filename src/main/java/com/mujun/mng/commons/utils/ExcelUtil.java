        ...
        for (int i = 0; i < excelMap.size(); i++) {
            ...
            for (int j = 0; j < filter.length; j++) {
                ...
                if (value != null) {
                    ...
                    if (c == java.math.BigDecimal.class || c == Integer.class || c == Long.class
    ...
    public static SXSSFWorkbook writeXlsxContent (SXSSFWorkbook workbook, String[] filter, List<Map<String, Object>> excelMap) {
        ...
        for (int i = 0; i < excelMap.size(); i++) {
            ...
            for (int j = 0; j < filter.length; j++) {
                ...
                if (value != null) {
                    Class<?> c = value.getClass();
                    if (c == java.math.BigDecimal.class || c == java.lang.Integer.class || c == java.lang.Long.class
                            || c == java.lang.Double.class || c == int.class || c == double.class || c == float.class) {
                        _cell = "" + value;
