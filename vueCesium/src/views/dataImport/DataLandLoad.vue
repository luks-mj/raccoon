                        ...
                        <el-row class="margin-bottom-10">
                           ...
                           <!-- <el-col :span="24">
                            ...
                            <el-col :span="24">
                                ...
                                <span><a href="../static/file/国土数据导入模板.xlsx" download="国土数据导入模板.xlsx">国土数据导入模板（Excel）</a>请严格遵循模板格式，否则会导入失败</span>
                            </el-form-item>
                            </el-col>
                            <el-col :span="24">
                                  <el-form-item label="" :label-width="formLabelWidth">
...
export default {
    ...
    computed: {
        calAction: function() {
             // 附件上传
            var ret = this.$CST.API_UPLOAD_FILE.replace('{year}', this.year).replace('{month}', this.month);
            return ret;
        },
    },
    watch: {}
